...
INSERT INTO oauth_client_details
(id,client_id, resource_ids, client_secret, `scope`, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove, app_name, fintech)
VALUES(3,'d6492371-762b-4768-937f-6be6b3cec29f', '1,2,3,4', '{bcrypt}$2a$10$vCXMWCn7fDZWOcLnIEhmK.74dvK1Eh8ae2WrWlhr2ETPLoxQctN4.', NULL, 'authorization_code,password,refresh_token,client_credentials', 'https://www.info-tech.com/app-callback', 'ROLE_CLIENT', 300, NULL, NULL, NULL, 'Digital Payment', 'Info-Tech');
